...
def _print_csr(csr):
    sys.stderr.write(acme_lib.get_csr_as_text(csr) + '\n')
...
if __name__ == "__main__":
    ...
    commands = {
        ...
        'get-certificate': {
            'help': 'Given a CSR and an account key, retrieves a certificate',
        ...
        'get-certificate-part-2': {
            'help': 'Assuming that get-certificate-part-1 ran through and the challenges were uploaded, retrieves a certificate.',
    ...
    parser.add_argument("--cert", required=False, help="file name to store certificate into")
